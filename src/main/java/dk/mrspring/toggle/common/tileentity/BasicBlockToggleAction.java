...
public class BasicBlockToggleAction implements IBlockToggleAction
{
    ...
    static
    {
        PLAYER_ROTATIONS[EnumFacing.UP.getIndex()] = 0;
        PLAYER_ROTATIONS[EnumFacing.DOWN.getIndex()] = 0;
        PLAYER_ROTATIONS[EnumFacing.NORTH.getIndex()] = 180;
        PLAYER_ROTATIONS[EnumFacing.SOUTH.getIndex()] = 0;
        PLAYER_ROTATIONS[EnumFacing.WEST.getIndex()] = 90;
        PLAYER_ROTATIONS[EnumFacing.EAST.getIndex()] = -90;
    }

    @Override
    public ItemStack[] harvestBlock(World world, BlockPos pos, EntityPlayer player, IToggleController controller)
    {
